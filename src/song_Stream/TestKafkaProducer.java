...
public class TestKafkaProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		String topicName = "SongStrea,";

		Producer<String, String> producer = sendDataToKafka(topicName, "Spotify data Project");
	...
	public static Producer<String, String> sendDataToKafka(String topicName, String event, String key) {
		Properties props = new Properties();
		props.put("bootstrap.servers", "localhost:9093, localhost:90");
		props.put("key.serializer", "org.apache.kafka.common.serialization.StringSerializer");
		props.put("value.serializer", "org.apache.kafka.common.serialization.StringSerializer");
